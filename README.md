...
### Note
It is better to have a larger batch size for PAC-tuning a Pretrained Languge Model on downstream text classification tasks. Please check the Section **6** for suggestions about how to use PAC-tuning for your specific tasks.